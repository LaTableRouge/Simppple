...
if (class_exists('WooCommerce')) { ?>
	<!-- wp:cover {"url":"<?php echo esc_url(get_template_directory_uri() . '/build/assets/src/img/placeholder.webp'); ?>","id":878,"dimRatio":50,"focalPoint":{"x":0.5,"y":0.5},"isDark":false,"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|40","right":"var:preset|spacing|30","left":"var:preset|spacing|30"}}},"className":"pattern\u002d\u002d-wc-search-banner"} -->
	<div
