...
/**
 * Title: 404
 * Slug: sample/page-404
 * Categories: sample-templates
 * Keywords: 404
 */
?>
...
<section class="wp-block-group pattern---404-v1">
	...
	<figure class="wp-block-image aligncenter size-full is-resized is-style-rounded">
		<img
			src="<?php echo esc_url(get_template_directory_uri() . SAMPLE_PICTURE_FOLDER . '/404.webp'); ?>"
			alt=""
			class="wp-image-302"
	...
	><?php echo _e("Oops! That page can't be found.", 'sample'); ?></h2>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"align":"center"} -->
	<p class="has-text-align-center"><?php _e('It looks like nothing was found at this location. Maybe try searching?', 'sample'); ?></p>
	<!-- /wp:paragraph -->

	<!-- wp:search {"label":"<?php _e('Search', 'sample'); ?>","showLabel":false,"placeholder":"<?php _e('Search a post, a page...', 'sample'); ?>","width":75,"widthUnit":"%","buttonText":"<?php _e('Search', 'sample'); ?>","buttonPosition":"no-button","align":"center"} /-->
	...
	<div class="wp-block-buttons">
		...
		<div class="wp-block-button">
			...
			><?php _e('Back to home page', 'sample'); ?></a>
		</div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
