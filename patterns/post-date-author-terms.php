 ...
 * Slug: simple/post-date-author-terms
 * Categories: date, author, terms, post
 */
?>

<!-- wp:group {"style":{"spacing":{"blockGap":"0.4rem"}},"className":"pattern\u002d\u002d-post-date-author-terms","layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group pattern---post-date-author-terms">
	...
	<div class="wp-block-group">
		...
		<p class="has-contrast-2-color has-text-color has-link-color"><?php _e('by', 'simple'); ?></p>
		<!-- /wp:paragraph -->
	...
	<div class="wp-block-group">
		<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast-2"}}}},"textColor":"contrast-2"} -->
		<p class="has-contrast-2-color has-text-color has-link-color"><?php _e('in', 'simple'); ?></p>
		<!-- /wp:paragraph -->
