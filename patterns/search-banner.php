 ...
 * Slug: simple/search-banner
 * Categories: simple-sections
 * Keywords: search, banner
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url(get_template_directory_uri() . SIMPLE_PICTURE_FOLDER . '/placeholder.webp'); ?>","id":878,"dimRatio":50,"focalPoint":{"x":0.5,"y":0.5},"isDark":false,"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|120","bottom":"var:preset|spacing|120"}}},"className":"pattern\u002d\u002d-search-banner"} -->
<div
