export const createInlineStyle = (object, id = '') => {
  ...
  if (Object.keys(object).length) {
    styleString += `.wp-block-highfive-modal#${id} .highfive-modal__inner-wrapper {`

    for (const key in object) {
      if (Object.hasOwnProperty.call(object, key)) {
        if (key !== 'breakpoints') {
          if (object[key]) {
            styleString += `--highfive-modal-${key}: ${object[key]};`
          }
        }
      }
    }
      ...
      for (const breakpoint in object.breakpoints) {
        if (Object.hasOwnProperty.call(object.breakpoints, breakpoint)) {
          ...
          if (Object.keys(configs).length) {
            styleString += `@container highfive-modal ${breakpoint} {`
            styleString += `.wp-block-highfive-modal#${id} .highfive-modal__inner-wrapper {`

            for (const key in configs) {
              if (Object.hasOwnProperty.call(configs, key)) {
                styleString += `--highfive-modal-${key}: ${configs[key]};`
              }
            }
