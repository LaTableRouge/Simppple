...
export default function Controls(props) {
	...
	return (
		<InspectorControls>
			<PanelBody className="highfive-modal__control-wrapper">

				<PanelBody className="control-wrapper__section" initialOpen={false} title={__('Configuration globale', 'highfive')}>
				...
				<PanelBody className="control-wrapper__section" initialOpen={false} title={__('Configuration du bouton de fermeture', 'highfive')}>
				...
				<PanelBody className="control-wrapper__section" initialOpen={false} title={__('Configuration du rendu', 'highfive')}>
					<OverlayColors attributes={attributes} setAttributes={setAttributes}/>
				</PanelBody>

				<PanelBody className="control-wrapper__section breakpoints" initialOpen={false} title={__('Responsive', 'highfive')}>
